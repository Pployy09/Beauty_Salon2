 ...
 if(monthNow <= 9 && dateNow <= 9){
    ...
    document.getElementById("dateEmpTable").setAttribute("min",t1);
 }else if(monthNow <= 9 && dateNow > 9){
    var t2 = yearNow + '-0' + monthNow +'-'+ dateNow ;
    document.getElementById("dateEmpTable").setAttribute("min",t2);
 }else if(dateNow <= 9 && monthNow > 9 ){
    var t3 = yearNow + '-' + monthNow +'-0'+ dateNow ;
    document.getElementById("dateEmpTable").setAttribute("min",t3);
 }else if(monthNow > 9 && dateNow > 9){
    var t4 = yearNow + '-' + monthNow +'-'+ dateNow ;
    document.getElementById("dateEmpTable").setAttribute("min",t4);
 }
};
...
function max(){
   if(dayNow === 1){
      ...
      document.getElementById("dateEmpTable").setAttribute("max",t6);
      ...
      document.getElementById("dateEmpTable").setAttribute("max",t7);
      ...
      document.getElementById("dateEmpTable").setAttribute("max",t8);
      ...
      document.getElementById("dateEmpTable").setAttribute("max",t9);
      ...
      document.getElementById("dateEmpTable").setAttribute("max",t10);
      ...
      document.getElementById("dateEmpTable").setAttribute("max",t11);
      ...
      document.getElementById("dateEmpTable").setAttribute("max",t12);
   }
